...
function genTestUserSig(userID) {
  if(sessionStorage.getItem('SECRETKEY')) SECRETKEY = sessionStorage.getItem('SECRETKEY');
  if(sessionStorage.getItem('SDKAPPID')) SDKAppID = Number(sessionStorage.getItem('SDKAPPID'));
